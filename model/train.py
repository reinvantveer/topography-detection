...
norm_sample_X, _ = next(normalization_generator)
train_datagen = ImageDataGenerator(
    horizontal_flip=True,
    vertical_flip=True,
    featurewise_std_normalization=True
)
train_datagen.fit(norm_sample_X)

# re-declare to use normalization
...
val_datagen.fit(norm_sample_X)  # re-use sampled data from training
